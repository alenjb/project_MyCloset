                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">${memberVO.member_name}</span>
<%--                             <c:forEach items="${myPage}" var="vo"> --%>
                            <small class="text-muted">${memberVO.member_id}</small>
...
<%--                           <input class="form-control" id="clothes_purchase_year" name="clothes_purchase_year" <fmt:formatDate value="${vo.clothes_purchase_year}" pattern="yyyy-MM-dd"/> readonly="readonly"/> --%>
							<fmt:formatDate value="${vo.clothes_purchase_year}" pattern="yyyy-MM-dd"/>
                        </div>
...
<!--                           <a href="/member/myPage"><button type="submit" class="btn btn-primary me-2" >수정완료</button></a> -->
                          <button type="button" class="btn btn-primary me-2" >수정</button>
                        </div>
                        </div>
                      </form>
                      </c:forEach>
