		...
		$("#submit-btn").click(function () {
			...
			let name = $('#name').val();
	          ...
	          $.ajax({
	              ...
	              url : "/member/findPw",      // 컨트롤러에서 대기중인 URL 주소이다.
	              data : {
	            	  id: id,
	            	  email : email,
	            	  name : name
	              ...
	              success : function(res){ // 비동기통신의 성공일경우 success콜백으로 들어옵니다. 'res'는 응답받은 데이터이다.
	                  if(res.pw == null){
	                	  alert("비밀번호를 찾을 수 없습니다. 아이디와 이메일, 이름을 다시 확인해 주세요.")
		 	                 location.href="/member/findPw";
	                  }
	                  else{
		                  alert("회원님의 비밀번호는 "+res.pw+"입니다.");
        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">아이디와 이메일, 이름을 입력하세요. 비밀번호를 찾을 수 있습니다.</p>
	         ...
	         <div class="modal fade" id="basicModal" tabindex="-1" aria-hidden="true">
	           <div class="modal-dialog" role="document">
	             <div class="modal-content">
	               ...
	               <div class="modal-body text-center app-brand justify-content-center">
	               	<span class="app-brand-logo demo">
                    <svg
                      width="25"
                      viewBox="0 0 25 42"
