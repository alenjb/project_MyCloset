		...
		<input type="hidden" name="perPageNum" value="${pageObject.perPageNum }">
		  <div class="input-group">
				  <select name="key" class="form-control">
				  	...
				  	<option value="cf" ${(pageObject.key == "tf")?"selected":"" }>내용/파일명</option>		  	
...
<!-- 	한페이지당 보여주는 데이터 개수 -->
	...
	<div class="row">
		...
		<c:forEach items="${list }" var="vo" varStatus="vs">
			...
			onclick="location='view.do?no=${vo.no}&page=${pageObject.page }&perPageNum=${pageObject.perPageNum }&key=${pageObject.key}&word=${pageObject.word}'" style="width:300px; height:600px">
